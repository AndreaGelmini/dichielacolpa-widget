var s={INIT:"dcec:init",SUBMIT:"dcec:submit",REDIRECT:"dcec:redirect",RETURN:"dcec:return"},w=["1 - Veicolo in sosta o in fermata","2 - Ripartiva dopo una sosta/apriva una portiera","3 - Stava parcheggiando","4 - Usciva da un parcheggio, da un luogo privato, da una strada vicinale","5 - Entrava in un parcheggio, in un luogo privato, in una strada vicinale","6 - Si immetteva su una piazza a senso rotatorio","7 - Circolava su una piazza a senso rotatorio","8 - Tampona procedendo nello stesso senso o nella stessa fila","9 - Procedeva nello stesso senso, ma in fila diversa","10 - Cambiava fila","11 - Sorpassava","12 - Girava a destra","13 - Girava a sinistra","14 - Retrocedeva","15 - Invadeva la sede stradale riservata alla circolazione in senso inverso","16 - Proveniva da destra","17 - Non aveva osservato il segnale di precedenza o di semaforo rosso"],g="https://dichielacolpa.it",E=`.dcec-widget {
    --dcec-primary: #2563eb;
